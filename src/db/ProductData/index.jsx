...
const ProductsData = [
    { id: 1, name: 'Spiced Mint', image: productOne, price: 9.99 },
    { id: 2, name: 'Sweet Straweberry', image: sweetStraweberry, price: 9.99 },
    { id: 3, name: 'Cool Blueberries', image: coolBlueberries, price: 9.99 },
    { id: 4, name: 'Juicy Lemon', image: juicyLemon, price: 9.99 },
    { id: 5, name: 'Product Name', image: productName, price: 9.99 },
    { id: 6, name: 'Fragrant Cinnamon', image: fragrantCinnamon, price: 9.99 },
    { id: 7, name: 'Summer Cherries', image: summerCherries, price: 9.99 },
    { id: 8, name: 'Clean Lavander', image: cleanLavander, price: 9.99 }
];
