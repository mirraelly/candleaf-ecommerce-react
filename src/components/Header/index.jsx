...
import { Collapse, Navbar, NavbarBrand, Nav, NavItem, NavLink, NavbarToggler, CloseButton } from 'reactstrap';
        ...
        <HeaderContainer>
                <Navbar color="faded" light className='border-bottom py-3'>
                    ...
                    <Nav className='col justify-content-end'>
                        <NavItem>
                            <NavLink href='' className='px-0'><img src={userIcon} alt='User icon' /></NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink href='/cart/'><img src={cart} alt='Cart icon' /></NavLink>
                        </NavItem>
                    </Nav>
